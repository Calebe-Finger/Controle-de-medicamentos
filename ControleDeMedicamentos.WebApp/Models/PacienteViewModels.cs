...
public class CadastrarPacienteViewModels
{
    ...
    public CadastrarPacienteViewModels() { }

    public CadastrarPacienteViewModels(string nome, string telefone, string cartaoSus,string cpf) : this()
    {
        Nome = nome;
        Telefone = telefone;
        CartaoSus = cartaoSus; 
